...
hintTable = {
    ...
    'Links House Cow':                                          ("the #cow in Links House# gives", None, 'always'),
    ...
    'Horseback Archery 1500 Points':                            ("scoring 1500 in #horseback archery# grants", None, 'always'),
    ...
    '1018':                                                     ("Phew... so far so good.^Hey, that's...^That blue hedgehog again, of all places...^I found you, faker!^Faker?^I think you're the fake hedgehog around here.^You're comparing yourself to me?^Ha!^You're not even good enough to be my fake.^I'll make you eat those words!", None, 'junk'),
    '1026':                                                     ("They say that @ isn't very good at Zelda.", None, 'junk'),
    ...
    '1058':                                                     ("Tuturu!", None, 'junk'),
    '1059':                                                     ("Just Monika.", None, 'junk'),
